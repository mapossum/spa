...
2) Slope less than or equal to a user specified value in degrees (This will be something the user will select in the toolbox).  You must restrict the value to a number between 0.1 and 10 degrees. 
...
Think about which tasks can be done before had.  Go ahead and process those, they do not need to be part of your script.  
