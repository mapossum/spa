...
2) Your program should also create a polygon shapefile that represents the animal’s home range.  The home range will be defined as the polyline shapefile you create buffered by 1km.
