...
input1 = arcpy.GetParameterAsText(0) #r"C:\courses\spa\W11\IntroToArcpy\Ex05\facilities.shp"
input2 = arcpy.GetParameterAsText(1) #r"C:\courses\spa\W11\IntroToArcpy\Ex05\parks.shp"
input1Buffered = "memory/Buffer"
BDist =  arcpy.GetParameterAsText(2) #"300 Meters"
outputdataset = arcpy.GetParameterAsText(3) #r"C:\courses\spa\W11\IntroToArcpy\IntroToArcpy.gdb\parks_Clip3"
