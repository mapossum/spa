...
#Specify Inputs
inputLayer = arcpy.GetParameterAsText(0) #r"G:\courses\spa\W9\IntroToArcpy\Ex05\parks.shp"
overlayLayer = arcpy.GetParameterAsText(1) #r"G:\courses\spa\W9\IntroToArcpy\Ex05\facilities.shp"
SQLExpression = arcpy.GetParameterAsText(2)
miles2Buffer = arcpy.GetParameterAsText(3) #1

#Specify Outputs
ClippedOutputLayer = arcpy.GetParameterAsText(4) #r"G:\courses\spa\W9\IntroToArcpy\Ex05\Outputlayer.shp"
